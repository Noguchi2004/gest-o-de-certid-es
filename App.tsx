...
export default function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data && data.ok) {
        setStatus({ type: 'success', message: 'Certidão cadastrada com sucesso!' });
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 py-8 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Cadastro de Certidões</h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">Preencha o formulário abaixo para registrar um novo documento.</p>
        </div>
